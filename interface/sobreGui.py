...
class SobreGui(tk.Frame):
    ...
    def make_widgets(self):
        ...
        ttk.Label(self, text='Informações sobre a Aplicação', font=('Helvetica', 14, 'bold')).pack(pady=10)
        app_info_text = (
            "Este é um exemplo de aplicativo Tkinter.\n"
            ...
            "O desenvolvedor se responsabiliza por uso indevido ou perca de dados.\n"
        ...
        ttk.Label(self, text='Licença', font=('Helvetica', 14, 'bold')).pack(pady=10)
        licence_text = (
            "Esta aplicação é licenciada sob Creative Commons Licence\n"
        ...
        ttk.Label(self, text='Informações do Desenvolvedor', font=('Helvetica', 14, 'bold')).pack(pady=10)
        developer_info_text = (
        ...
        # Donation Link
        ttk.Label(self, text='Faça uma doação para apoiar o desenvolvimento:', font=('Helvetica', 12)).pack(pady=5)
        donation_link = ttk.Label(self, text='Doar agora', cursor='hand2', foreground='blue', font=('Helvetica', 12, 'underline'))
    ...
    def open_donation_link(self):
        ...
        webbrowser.open_new_tab('https://mywins.eu')