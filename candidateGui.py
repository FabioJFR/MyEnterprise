...
class CandidateGui(tk.Frame):
    def __init__(self, master, controller):
        ...
        self.shelveName = '/Volumes/Programing/VSCode_Projects/programing_python_book/5_step_Adding_GUI/pratica_conhecimento/MyEnterprise/candidate_database'  # Update with the actual path
    ...
    def update_record(self):
        ...
        if key in self.db.keys():
            ...
            record = Candidate(name='?', age='?', aplying_job='?', phone=0, email='?', social_network='?',
                                adress='?', country='?', date=0, status='?', doc_ident=0, nif=0, nacionality='?',
...
class CandidateGui(tk.Frame):
    def __init__(self, master, controller):
        super().__init__(master)
        self.controller = controller
        self.shelveName = '/Volumes/Programing/VSCode_Projects/programing_python_book/5_step_Adding_GUI/pratica_conhecimento/MyEnterprise/candidate_database'
        self.fieldnames = ('name', 'age','aplying_job','phone', 'email','social_network', 'adress', 'country', 'date', 'status', 'doc_ident', 'nif', 'nacionality', 'height', 'weight','resume')
        self.entries = {}
    ...
    def update_record(self):
        ...
        if key in self.db.keys():
            ...
            record = Candidate(name='?', age='?',aplying_job='?' ,phone=0, email='?',social_network='?', adress='?', country='?', date=0, status='?', doc_ident=0, nif=0, nacionality='?', height=0, weight=0, resume='?')
